...
function signi = SigCalcu(varargin)
...
signifi= round(size (Wxy1, 2) * 0.5);


for s = 1 : size (Wxy1, 1)
    for t = 1 : size (Wxy1, 2) 
        xwtavg(s, t) = (Wxy1(s, t) + Wxy2(s, t) + Wxy3(s, t) + Wxy4(s, t) + Wxy5(s, t) + Wxy6(s, t) + Wxy7(s, t)); 
%         RCwtavg(s) = (rain1(s, t) + rain2(s, t) + rain3(s, t) + rain4(s, t) + rain5(s, t) + rain6(s, t) + rain7(s, t));  
%         TCwtavg(s) = (traffic1(s, t) + traffic2(s, t) + traffic3(s, t) + traffic4(s, t) + traffic5(s, t) + traffic6(s, t) + traffic7(s, t));  

    end

%     xwtavg(s) = (sum (Wxy1(s, :)) + sum (Wxy2(s, :)) + sum (Wxy3(s, :)) + sum (Wxy4(s, :)) + sum (Wxy5(s, :)) + sum (Wxy6(s, :)) + sum (Wxy7(s, :))); 
